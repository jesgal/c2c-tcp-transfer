...
'''
Esta clase se encarga de buscar y enviar los ficheros
'''
class SearchAndSend():
    # Constructor
    ...
    # Localiza ficheros por palabra clave
    # Retorna lista de rutas de fichero.
    ...
    # Orquesta el envío de los ficheros
...
"""
Esta clase se queda en modo escucha
Espera la recepción de un comando con los parámetros para iniciar la búsqueda de ficheros
Activa la búsqueda y envío de ficheros al servidor remoto mediante protocolo TCP
"""
class WaitForOrder():
    # Constructor
    def __init__(self):
    ...
    '''
    # Procesa los paquetes del proceso de sniffing
...
# Define el menú de la aplicación
def menu():
    # Crear el parser
